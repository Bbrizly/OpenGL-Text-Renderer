...
void FontDad::LoadFont(const string& fontPath){//, const vector<string>& texturePaths) {
...
const CharInfo& FontDad::GetCharacter(char c) const {
...
const unordered_map<std::pair<char, char>, int, PairHash>& FontDad::GetKerning() const {
    return m_kerning;
}
