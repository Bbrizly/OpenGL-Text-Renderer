...
public:
    Main() : App("Text Renderer") {
        ...
        TextBox* textBoz = m_textRenderer->createTextBox(font1, "HEALTH: 87%", 010, 700, 200, 100);
        ...
        TextBox* textBov = m_textRenderer->createTextBox(font1, "Graphics 436: Assignment111, Graphics 436: Assignment111, Graphics 436: Assignment111, Graphics 436: Assignment111, Graphics 436: Assignment111, Graphics 436: Assignment111", 100, 500, 400, 100);


        table.SetLanguage("English");
        table.SetStringProperty("playerName","Bassa m Kamal");
